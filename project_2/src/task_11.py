...
if __name__ == "__main__":
    ...
    optimizers = [
        optimizer.GoodBroyden(
            problem, line_seach, g_tol=g_tol, x_tol=x_tol, max_iterations=max_iter
        ),
    ...
    for opt, opt_name in zip(optimizers, opt_names):
        ...
        for x0, n in zip(X0, N):
            ...
            print(f"    num_iterations: {len(x_list)}")
    ...
    optimization = BFGS(
        problem, line_seach, max_iterations=max_iter, g_tol=g_tol, x_tol=x_tol
    )
